...
(assert-eq (subclassp (class-of 's) (class <built-in-class>)) t)
(assert-eq (subclassp (class <keyword>) (class <built-in-class>)) t)
(assert-eq (subclassp (class-of :keyword) (class <built-in-class>)) t)
(assert-eq (subclassp (class <cons>) (class <built-in-class>)) t)
(assert-eq (subclassp (class-of (cons 1 2)) (class <built-in-class>)) t)
(assert-eq (subclassp (class-of (create-string-output-stream)) (class <built-in-class>)) t)
(assert-eq (subclassp (class <integer>) (class <built-in-class>)) t)
(assert-eq (subclassp (class-of 1) (class <built-in-class>)) t)
(assert-eq (subclassp (class <float>) (class <built-in-class>)) t)
(assert-eq (subclassp (class-of 1.1) (class <built-in-class>)) t)
(assert-eq (subclassp (class <string>) (class <built-in-class>)) t)
