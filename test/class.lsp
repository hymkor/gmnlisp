...
(test (subclassp <array> <built-in-class>) t)
(test (subclassp (class-of #(1 2 3)) <built-in-class>) t)
(test (subclassp (class-of t) <built-in-class>) t)
(test (subclassp (class-of nil) <built-in-class>) t)
(test (subclassp <string> <built-in-class>) t)
(test (subclassp (class-of 's) <built-in-class>) t)
(test (subclassp <keyword> <built-in-class>) t)
(test (subclassp (class-of :keyword) <built-in-class>) t)
(test (subclassp <cons> <built-in-class>) t)
(test (subclassp (class-of (cons 1 2)) <built-in-class>) t)
(test (subclassp (class-of (create-string-output-stream)) <built-in-class>) t)
(test (subclassp <integer> <built-in-class>) t)
(test (subclassp (class-of 1) <built-in-class>) t)
(test (subclassp <float> <built-in-class>) t)
(test (subclassp (class-of 1.1) <built-in-class>) t)
(test (subclassp <string> <built-in-class>) t)
(test (subclassp (class-of "a") <built-in-class>) t)
(test (subclassp <point1d> <built-in-class>) nil)
