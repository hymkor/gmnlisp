...
var embedFunctions = map[Symbol]Node{
	...
	NewSymbol("set-elt"):     &LispString{S: `(lambda-macro (newvalue seq &rest z) (list 'if (list 'arrayp seq) (list 'set-array-elt newvalue seq @z) (list 'setf seq (list 'swap-elt newvalue seq @z))))`},
