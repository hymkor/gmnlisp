...
func New() *World {
	return &World{
		globals: map[Symbol]Node{
			...
			"cadddr":              &LeftValue2F{C: 1, F: funCadddr},
			"caddr":               &LeftValue2F{C: 1, F: funCaddr},
			"cadr":                &LeftValue2F{C: 1, F: funCadr},
			"car":                 &LeftValue2F{C: 1, F: funGetCar},
			"cdddr":               &LeftValue2F{C: 1, F: funCdddr},
			"cddr":                &LeftValue2F{C: 1, F: funCddr},
			...
			"nth":                 &LeftValue2F{C: 2, F: funNth},
			"nthcdr":              &LeftValue2F{C: 2, F: funNthcdr},
