...
func New() *World {
	return &World{
		globals: map[Symbol]Node{
			...
			"cadddr":              &SetGetF{C: 1, F: funCadddr},
			"caddr":               &SetGetF{C: 1, F: funCaddr},
			"cadr":                &SetGetF{C: 1, F: funCadr},
			"car":                 &SetGetF{C: 1, F: setGetCar},
			"cdddr":               &SetGetF{C: 1, F: funCdddr},
			"cddr":                &SetGetF{C: 1, F: funCddr},
			"cdr":                 &SetGetF{C: 1, F: setGetCdr},
			...
			"nth":                 &SetGetF{C: 2, F: funNth},
			"nthcdr":              &SetGetF{C: 2, F: funNthcdr},
